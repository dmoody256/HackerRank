...
TEST_CASE("This test will create and add big ints from generated and hardcoded values", "[BigInt]") {
	...
	static const BigInt bigIntHardCodeOperon1[] = {
		...
		std::string("1000000000001"),
		std::string("100000000000000000001"),
		std::string("1000000000000000000000001"),
		std::string("10000000000000000000000000001"),
		std::string("100000000000000000000000000000001"),
		std::string("10000000000000000000000000000000000000001"),
		std::string("1000000000000000000000000000000000000000000000001"),
		std::string("100000000000000000000000000000000000000000000000000000001"),
		std::string("9999999999999999999999"),
		std::string("9999999999999999999999999999999999999999999999999"),
		std::string("9999999999999999999999999999999999999999999999999"),
		std::string("8070348572037465023476501862481273498126501982651"),
		std::string("407561304876501763540875234726387423740912301283701273673640523606491278364091736498752340762354917623549162534971523041396451293764519231976345913745691345013465703475630475613407563045107435601237561")
	};


	static const BigInt bigIntHardCodeOperon2[] = {
		std::string("0"),
		std::string("100000002"),
		std::string("1000000000002"),
		std::string("100000000000000000002"),
		std::string("1000000000000000000000002"),
		std::string("10000000000000000000000000002"),
		std::string("100000000000000000000000000000002"),
		std::string("10000000000000000000000000000000000000002"),
		std::string("1000000000000000000000000000000000000000000000002"),
		std::string("100000000000000000000000000000000000000000000000000000002"),
		std::string("1"),
		std::string("1"),
		std::string("9999999999999999999999999999999999999999999999999"),
		std::string("2873465028736405826340562304985601986450198264051263"),
		std::string("")
	};

	static const BigInt bigIntHardCodeSum[] = {
		std::string("0"),
		std::string("200000003"),
		std::string("2000000000003"),
		std::string("200000000000000000003"),
		std::string("2000000000000000000000003"),
		std::string("20000000000000000000000000003"),
		std::string("200000000000000000000000000000003"),
		std::string("20000000000000000000000000000000000000003"),
		std::string("2000000000000000000000000000000000000000000000003"),
		std::string("200000000000000000000000000000000000000000000000000000003"),
		std::string("10000000000000000000000"),
		std::string("10000000000000000000000000000000000000000000000000"),
		std::string("19999999999999999999999999999999999999999999999998"),
		std::string("2881535377308443291364038806848083259948324766033914"),
		std::string("")
	};
